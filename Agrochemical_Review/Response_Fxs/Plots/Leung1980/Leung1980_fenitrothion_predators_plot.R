...
source("Agrochemical_Review/Response_Fxs/Leung1980_fenitrothion_predators_fit.R")
...
plot(leung_dat$conc, leung_dat$mort, pch = 16, ylim = c(0,1), xlim = c(0,110),
     ...
     main = "Leung 1980 Fenitrothion toxicity")

  set.seed(43093)
  
  points(c(0:120), sapply(c(0:120)*1000, muPq_fenitrothion_Leung_uncertainty),
         pch = 5, col = 4, cex = 0.5)
...
plot(leung_dat_juv$conc, leung_dat_juv$mort, pch = 16, ylim = c(0,1), xlim = c(0,10),
     xlab = "Fenitrothion (ppm)", ylab = "mortality",
     main = "Leung 1980 Fenitrothion toxicity to juveniles")

  set.seed(43093)
  
  points(seq(0,10,0.1), sapply(seq(0,10,0.1)*1000, muPq_juv_fenitrothion_Leung_uncertainty),
         pch = 5, col = 4, cex = 0.5)
  legend("topleft", bty="n", pch = c(16, 5), col = c(1,4), 
         legend = c("Reported", "Sampled"), cex = 0.75)
