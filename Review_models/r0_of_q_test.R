...
parameters=c(
  ...
  theta = 109/7,       # cercarial shedding rate in snails (cercariae/I-snail/day); Pfluger 1984
  pi_C = 14.21,          # cercariae-hours per day
  
  # transmission parameters
  beta = 1.677e-5/24,    #Human-to-snail infection probability in reference area (infected snails/miracidia/snail/day); 
                         #  divided by 24 to account for hourly scale of miracidial survival
                         #  mean from Halstead et al fit weighted by likelihood
  sigma = 1/40,         # Latent period for exposed snails (infectious snails/exposed snail/day))
  lamda = 9.450e-5/24,   # Snail-to-human infection probability per cercaria; divided by 24 to account for hourly scale of miracidial survival
...
r0.In(In = 0)  #R0 = 3.49: coexistence of snail population, pred population, and disease @ pred density of 0.1/m^2
