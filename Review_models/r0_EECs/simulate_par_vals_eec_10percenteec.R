...
keep.all = c(keep.baxrohr, keep.johnson07, 'rohr08_fN_uncertainty', 'rohr08_fN_uncertainty2', keep.halstead17, keep.bak.all, keep.tch91.snail, keep.gaf.all, keep.bak11.N, keep.hsh.all, keep.ibr.ch, keep.ons.all, keep.muN.tantawy, keep.ragab.mun, keep.hal15.muP, keep.all.sat09, keep.grg08, keep.kop06.beq, keep.atr.rohr08, keep.meta.piC, keep.tantawy.piC, keep.gaf.piC, keep.tch92.beq, keep.hsh.pic, keep.hsh.pim, keep.gaf.piM, keep.tch91.beq, keep.tantawy.piM, keep.tch91.Fe, keep.tch91.egv, 'keep.all')

rm(list = setdiff(ls(), keep.all))
dev.off()
