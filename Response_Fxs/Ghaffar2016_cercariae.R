...
plot(pen.cer$pendimethalin, gaf.pen.aucs.cer/gaf.pen.aucs.cer[1],
     ...
     pch = 16, ylim = c(0,1))
  points(seq(0,4000,25)/1000, sapply(seq(0,4000,25), piC.ghaf_pen.lin_unc, simplify = T),
         pch = 5, col = 4, cex = 0.5)
  points(seq(0,4000,25)/1000, sapply(seq(0,4000,25), piC.ghaf_pen.exp_unc, simplify = T),
         pch = 5, col = 2, cex = 0.5)
