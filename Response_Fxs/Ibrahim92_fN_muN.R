...
f_N_chlor_ibr92 = function(In){
  ...
  f_N_chlor_ibr92_uncertainty<-function(In){
    ...
    points(seq(0, 1000, 2), sapply(seq(0, 1000, 2), f_N_chlor_ibr92_uncertainty, simplify = T),
               pch = 5, cex = 0.6, col = 4)
...
#Snail mortality #############
  ...
  mu_N_chlor_ibr92 = function(In){
    ...
    lines(seq(0, 1000, 10), sapply(seq(0, 1000, 10), mu_N_chlor_ibr92, simplify = T)[1,],
            lty = 2, col = 2)
    lines(seq(0, 1000, 10), sapply(seq(0, 1000, 10), mu_N_chlor_ibr92, simplify = T)[2,],
            lty = 3, col = 2)
    lines(seq(0, 1000, 10), sapply(seq(0, 1000, 10), mu_N_chlor_ibr92, simplify = T)[3,],
            lty = 3, col = 2)
...
par.tricks.ibr.muN = c(coef(ibr_muNq), 
  ...
  mu_N_chlor_ibr92_uncertainty<-function(In){
    rdrm(nosim = 1, fct = L.4(), mpar = par.tricks.ibr.muN, yerror = 'rbinom', xerror = In,
         ypar = 30)$y / 30
  }
