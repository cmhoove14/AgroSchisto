...
rohr.atr.fx = function(He){
  ...
  lines(log(c(0:2000)+1), sapply(c(0:2000), rohr.atr.fx)[1,], lty = 2)
  lines(log(c(0:2000)+1), sapply(c(0:2000), rohr.atr.fx)[2,], lty = 3)
  lines(log(c(0:2000)+1), sapply(c(0:2000), rohr.atr.fx)[3,], lty = 3)
