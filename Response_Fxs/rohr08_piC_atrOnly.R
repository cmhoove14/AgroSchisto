...
atr.lin = glm(surv ~ log_conc, weights = st_err^-1, data = atr)
...
#Final function estimates relative mortality to He=0 and is interpreted as pi_C parameter      
  piC.atr.rohr08.uncertainty = function(He){
    rdrm(1, LL.2(), coef(atr.drm), He, yerror = 'rbinom', ypar = 80)$y / 80
  }    
...
#Vector of items to keep
  keep.atr.rohr08 = c('piC.atr.rohr08.uncertainty', 'atr.drm', 'atr.lin', 'piC.atr.rohr08.lin')