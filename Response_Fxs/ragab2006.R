...
lc90.amm.rag = 640
  slp.amm.rag = (qnorm(0.9, mean = 5) - qnorm(0.5, mean = 5)) / 
                log10(lc90.amm.rag / lc50.amm.rag)
...
plot(c(lc50.amm.rag, lc90.amm.rag)*1000, c(0.5, 0.9), pch = 16,
...
lc90.pot.rag = 2600
slp.pot.rag = (qnorm(0.9, mean = 5) - qnorm(0.5, mean = 5)) / 
              log10(lc90.pot.rag / lc50.pot.rag)
...
plot(c(lc50.pot.rag, lc90.pot.rag)*1000, c(0.5, 0.9), pch = 16,
...
lc90.urea.rag = 31000
slp.urea.rag = (qnorm(0.9, mean = 5) - qnorm(0.5, mean = 5)) / 
               log10(lc90.urea.rag / lc50.urea.rag)
...
plot(c(lc50.urea.rag, lc90.urea.rag)*1000, c(0.5, 0.9), pch = 16,
