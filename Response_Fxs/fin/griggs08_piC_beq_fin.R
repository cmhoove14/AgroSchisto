...
plot(c(0,15,100), grg08_atr_aucs/grg08_atr_aucs[1], ylim = c(0,1),pch = 16, cex = 1.2,
  ...
  points(seq(0, 500, 5), sapply(seq(0, 500, 5), piC.grg08_atr_unc), pch = 5, col = 2, cex = 0.5)
  points(seq(0, 500, 5), sapply(seq(0, 500, 5), piC.grg08_atr_unc2), pch = 5, cex = 0.5, col = 4)
...
plot(seq(0, 500, 5), sapply(seq(0, 500, 5), piC.grg08_atr_unc2), pch = 17, cex = 0.5,
