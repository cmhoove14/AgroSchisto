...
zinc.lwmod.sat09 = lm(cbitpfx ~ log10dose, data = zinc.lw1949[zinc.lw1949$LWkeep, ])
  ...
  muPq_zinc_satapornvanit09_uncertainty_lw49 = function(In){
    ...
    points(seq(0,800,2), sapply(seq(0,800,2), muPq_zinc_satapornvanit09_uncertainty_lw49),
           pch = 5, col=6, cex = 0.5)
...
dim.lwmod.sat09 = lm(cbitpfx ~ log10dose, data = dim.lw1949[dim.lw1949$LWkeep, ])
  ...
  muPq_dim_satapornvanit09_uncertainty_lw49 = function(In){
    ...
    points(seq(0,1300,2), sapply(seq(0,1300,2), muPq_dim_satapornvanit09_uncertainty_lw49),
           pch = 5, col=6, cex = 0.5)
...
muPq_prof_satapornvanit09_uncertainty_lw49 = function(In){
  ...
  points(seq(0,60,0.1), sapply(seq(0,60,0.1), muPq_prof_satapornvanit09_uncertainty_lw49),
         pch = 5, col=6, cex = 0.5)
