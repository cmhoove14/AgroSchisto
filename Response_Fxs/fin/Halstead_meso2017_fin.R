...
#Fertilizer bottom up effects  
  halstead17_phiN_fe_uncertainty = function(waste){ #function based on snail hatchlings
    wst = waste
...
#Atrazine bottom up effects  
  halstead17_phiN_at_uncertainty = function(waste){ #function based on snail hatchlings
    wst = waste
...
keep.halstead17 = c('halstead17_phiN_at_uncertainty', 'at.mean', 'at.sd', 'ref.mean',
                    'halstead17_phiN_fe_uncertainty', 'fe.mean', 'fe.sd')    
