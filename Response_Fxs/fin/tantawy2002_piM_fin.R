...
#keep vector for butachlor toxicity to miracidia
  keep.tant.but.piM = c('piM.tant02_but.lin_unc', 'piM.tant02_but.lin_auc0', 'piM.tant02_but.exp_unc', 'piM.tant02_but.exp_auc0',
                        'el.but.mir', 'el.but2.mir', 'bl.but.mir', 'L.3.fx')
...
el.fpb2.mir = lm(e ~ logfpb, weights = e.se^-1, data = mir.fpb) #log-linear response of LC50
  ...
  lines(seq(0,18,0.1), sapply(seq(0,18,0.1), el.pred2.mir.fpb, simplify = T)[3,], lty = 3, col=3)
    ...
    AIC(el.fpb.mir, el.fpb2.mir)  #exponential is a better fit    
...
#keep vector for fluazifop-p-butyl toxicity to miracidia
  keep.tant.fpb.piM = c('piM.tant02_fpb.lin_unc', 'piM.tant02_fpb.lin_auc0', 'piM.tant02_fpb.exp_unc', 'piM.tant02_fpb.exp_auc0',
                        'el.fpb.mir', 'el.fpb2.mir', 'bl.fpb.mir', 'L.3.fx')
